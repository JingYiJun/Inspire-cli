"""Run command flow for quick job submission.

Kept separate so `run.py` can focus on Click wiring.
"""
...
from inspire.cli.commands.run_helpers import (
    _check_uncommitted_changes,
    _exec_inspire_subcommand,
    _get_current_branch,
    _run_inspire_subcommand,
)
