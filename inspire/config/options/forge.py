...
GITEA_OPTIONS: list[ConfigOption] = [
    ...
    ConfigOption(
        ...
        description="Fallback workflow filename for retrieving logs when SSH tunnel is unavailable",
    ...
    ConfigOption(
        ...
        description="Fallback workflow filename for code sync (planned for future deprecation)",
    ...
    ConfigOption(
        ...
        description="Fallback workflow filename for bridge execution (planned for future deprecation)",
...
GITHUB_OPTIONS: list[ConfigOption] = [
    ...
    ConfigOption(
        ...
        description="Fallback workflow filename for retrieving logs when SSH tunnel is unavailable (GitHub)",
        default="retrieve_job_log.yml",
        category="GitHub",
        scope="project",
    ),
    ConfigOption(
        ...
        description="Fallback workflow filename for code sync (GitHub; planned for future deprecation)",
        default="sync_code.yml",
        category="GitHub",
        scope="project",
    ),
    ConfigOption(
        ...
        description="Fallback workflow filename for bridge execution (GitHub; planned for future deprecation)",
        default="run_bridge_action.yml",
        category="GitHub",
        scope="project",
    ),
